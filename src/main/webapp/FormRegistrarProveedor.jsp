...
<body>
	<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
		...
		<div
			...
			<h2
				class=" text-center text-2xl/9 font-bold tracking-tight text-gray-900 mb-5">Registrar
				proveedor</h2>
			<form class="space-y-6" action="ControladorProveedor" method="POST">
				<div>
					...
					<div class="mt-2">
						<input type="text" name="nomproveecl2" id="nomproveecl2"
							autocomplete="nomproveecl2" required
				...
				<div>
					...
					<div class="mt-2">
						<input type="text" name="rsocialproveecl2" id="rsocialproveecl2"
							autocomplete="rsocialproveecl2" required
							class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-500 sm:text-sm/6">
					</div>
				</div>
				...
				<div>
					...
					<div class="mt-2">
						<input type="number" name="rucproveecl2" id="rucproveecl2"
							autocomplete="rucproveecl2" required
							class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-500 sm:text-sm/6">
					</div>
				</div>
				...
				<div>
					...
					<div class="mt-2">
						<input type="email" name="emailproveecl2" id="emailproveecl2"
							autocomplete="emailproveecl2" required
							class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-500 sm:text-sm/6">
					</div>
				</div>
				...
				<div>
					...
					<div class="mt-2">
						<input type="date" name="feingproveecl2" id="feingproveecl2"
							autocomplete="feingproveecl2" required
							class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-500 sm:text-sm/6">
					</div>
				</div>
				...
				<div>
					<button type="submit"
					value="registrar"
						class="flex w-full justify-center rounded-md bg-blue-500 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-sky-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500">Registrar</button>
				</div>
			</form>
